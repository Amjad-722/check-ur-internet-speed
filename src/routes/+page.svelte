				...
				<div class="text-center">
					...
					<div
						class="text-8xl font-light {maxSpeedReached
							? 'text-gray-500'
							: 'text-green-400'} mb-4 tracking-tight"
					>
					...
					{:else}
						<div class="mt-6 flex justify-center">
							<div class="flex animate-pulse space-x-1">
								...
								<div
									class="h-2 w-2 animate-bounce rounded-full bg-green-400"
		...
		<div class="mx-auto max-w-4xl">
			<div class="flex justify-center space-x-8">
				...
				<a
					...
					target="_blank"
					rel="noopener noreferrer"
					class="group flex items-center space-x-2 text-gray-400 transition-colors hover:text-indigo-400"
				>
					<svg class="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
						<path
